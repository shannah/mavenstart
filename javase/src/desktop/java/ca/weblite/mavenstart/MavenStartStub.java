 ...
 * @author Shai Almog
 */
public class MavenStartStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MavenStart";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MavenStartStub());
    }
